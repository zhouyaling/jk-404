var provinceData = [
    ...
    { province: "青海省", className: "Z-SF4" },
    { province: "内蒙古", className: "Z-SF5" },
	{ province: "内蒙古自治区", className: "Z-SF5" },
    { province: "宁夏", className: "Z-SF6" },
    { province: "宁夏自治区", className: "Z-SF6" },
    { province: "宁夏回族自治区", className: "Z-SF6" },
    ...
    { province: "广西自治区", className: "Z-SF14" },
    { province: "广西壮族自治区", className: "Z-SF14" },
